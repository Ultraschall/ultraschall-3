...
pkgbuild --root ./Modules/Soundboard/Payload/Scripts --identifier fm.ultraschall.Soundboard.Scripts --install-location Library/Application\ Support ./Build/UltraschallSoundboardScripts-1.2.pkg
