...
export ULTRASCHALL_RELEASE=Ultraschall-3.1-beta7
...
echo '
   tell application "Finder"
     tell disk "Ultraschall-3.1-beta7.intermediate"
           open
           ...
           set position of item "Ultraschall-3.1-beta7.pkg" of container window to {50, 30}
