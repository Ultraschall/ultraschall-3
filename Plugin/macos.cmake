...
ExternalProject_Add(curl
    ...
    STEP_TARGETS build
    EXCLUDE_FROM_ALL TRUE
	CMAKE_ARGS -DBUILD_CURL_EXE=OFF -DBUILD_SHARED_LIBS=OFF -DHTTP_ONLY=ON -DENABLE_IPV6=ON -DCMAKE_USE_DARWINSSL=ON -DCURL_CA_PATH=none -DBUILD_TESTING=OFF
)
...
ExternalProject_Add(wxwidgets
    ...
    STEP_TARGETS build
    EXCLUDE_FROM_ALL TRUE
    CMAKE_ARGS -DBUILD_SHARED_LIBS=OFF -DwxBUILD_SAMPLES=OFF -DwxBUILD_TESTS=OFF -DwxBUILD_DEMOS=OFF -DwxBUILD_INSTALL=OFF -DwxUSE_STL=ON -DwxUSE_STD_CONTAINERS=ON -DwxUSE_LIBPNG=sys -DwxUSE_LIBJPEG=sys -DwxUSE_LIBTIFF=sys -DCMAKE_OSX_DEPLOYMENT_TARGET=10.11 -DwxUSE_SOUND=OFF
)
