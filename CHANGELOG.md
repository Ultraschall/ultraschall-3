...
* Mastering: **New EQ Preset**
*Ultraschall 3 includes a new EQ preset, that delivers less bass boost then the preset from version 2. It is a good starting point for the headsets [DT297](https://www.thomann.de/en/beyerdynamic_dt297pv80_mk_ii.htm?partner_id=60110) and [HMC660](https://www.thomann.de/gb/superlux_hmc_660_x.htm?partner_id=60110).*
