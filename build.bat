...
set ULTRASCHALL_RELEASE_LABEL=Ultraschall-3.1-beta14
...
copy "%ProgramFiles(x86)%\Microsoft Visual Studio\2017\Professional\VC\Redist\MSVC\14.11.25325\MergeModules\Microsoft_VC141_CRT_x64.msm" Payload\VCRedist
